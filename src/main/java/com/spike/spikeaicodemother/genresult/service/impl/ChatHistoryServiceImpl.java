...
import com.spike.spikeaicodemother.genresult.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory>  implements ChatHistoryService{
    ...
    @Override
    public boolean addMessage(Long appId, String message, String messageType, Long userId) {
        //校验
