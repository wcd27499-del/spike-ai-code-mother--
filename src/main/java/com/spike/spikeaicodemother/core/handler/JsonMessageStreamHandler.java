package com.spike.spikeaicodemother.core.handler;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.spike.spikeaicodemother.ai.model.message.*;
import com.spike.spikeaicodemother.constant.AppConstant;
import com.spike.spikeaicodemother.core.builder.VueProjectBuilder;
import com.spike.spikeaicodemother.core.tool.BaseTool;
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    chatHistoryService.addMessage(appId, aiResponse, ChatHistoryMessageTypeEnum.AI.getValue(), loginUser.getId());
                    //异步构建项目
...
//                    vueProjectBuilder.buildProjectAsync(projectPath);
                ...
                .doOnError(error -> {
                    ...
                    chatHistoryService.addMessage(appId, errorMessage, ChatHistoryMessageTypeEnum.AI.getValue(), loginUser.getId());
                });
    }
